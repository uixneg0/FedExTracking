...
public class CompleteTrackResult {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof CompleteTrackResult)) {
			return false;
		}
		CompleteTrackResult rhs = ((CompleteTrackResult) other);
		return (((Objects.equals(this.trackResults, rhs.trackResults)) && (Objects.equals(this.additionalProperties, rhs.additionalProperties))) && (Objects.equals(this.trackingNumber, rhs.trackingNumber)));
	}
