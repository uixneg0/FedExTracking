...
public class Address__2 {
    ...
    public Address__2 withCity(String city) {
        this.city = city;
        return this;
    }
    ...
    public Address__2 withStateOrProvinceCode(String stateOrProvinceCode) {
        this.stateOrProvinceCode = stateOrProvinceCode;
        return this;
    }
    ...
    public Address__2 withCountryCode(String countryCode) {
        this.countryCode = countryCode;
        return this;
    }
    ...
    public Address__2 withResidential(Boolean residential) {
        this.residential = residential;
        return this;
    }
    ...
    public Address__2 withCountryName(String countryName) {
        this.countryName = countryName;
        return this;
    }
    ...
    public Address__2 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
