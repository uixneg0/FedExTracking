...
public class ServiceCommitMessage {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof ServiceCommitMessage)) {
			return false;
		}
		ServiceCommitMessage rhs = ((ServiceCommitMessage) other);
		return (((Objects.equals(this.additionalProperties, rhs.additionalProperties)) && (Objects.equals(this.message, rhs.message))) && (Objects.equals(this.type, rhs.type)));
	}
