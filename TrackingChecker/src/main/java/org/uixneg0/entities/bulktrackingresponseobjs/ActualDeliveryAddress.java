...
public class ActualDeliveryAddress {
	...
	public ActualDeliveryAddress withCity(String city) {
		this.city = city;
		return this;
	}
	...
	public ActualDeliveryAddress withStateOrProvinceCode(String stateOrProvinceCode) {
		this.stateOrProvinceCode = stateOrProvinceCode;
		return this;
	}
	...
	public ActualDeliveryAddress withCountryCode(String countryCode) {
		this.countryCode = countryCode;
		return this;
	}
	...
	public ActualDeliveryAddress withResidential(Boolean residential) {
		this.residential = residential;
		return this;
	}
	...
	public ActualDeliveryAddress withCountryName(String countryName) {
		this.countryName = countryName;
		return this;
	}
	...
	public ActualDeliveryAddress withAdditionalProperty(String name, Object value) {
		this.additionalProperties.put(name, value);
		return this;
	}
	...
	public String toString() {
		...
		sb.append(ActualDeliveryAddress.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
		sb.append("city");
		sb.append('=');
	...
	public boolean equals(Object other) {
		...
		if ((other instanceof ActualDeliveryAddress) == false) {
			return false;
		}
		ActualDeliveryAddress rhs = ((ActualDeliveryAddress) other);
