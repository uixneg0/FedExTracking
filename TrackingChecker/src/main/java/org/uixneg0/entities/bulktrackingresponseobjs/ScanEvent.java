...
public class ScanEvent {
	...
	public boolean equals(Object other) {
		...
		return ((((((((((Objects.equals(this.date, rhs.date)) && (Objects.equals(this.derivedStatus, rhs.derivedStatus))) && (Objects.equals(this.scanLocation, rhs.scanLocation))) && (Objects.equals(this.exceptionDescription, rhs.exceptionDescription))) && (Objects.equals(this.eventDescription, rhs.eventDescription))) && (Objects.equals(this.locationType, rhs.locationType))) && (Objects.equals(this.eventType, rhs.eventType))) && (Objects.equals(this.derivedStatusCode, rhs.derivedStatusCode))) && (Objects.equals(this.additionalProperties, rhs.additionalProperties))) && (Objects.equals(this.exceptionCode, rhs.exceptionCode)));
	}
